    ...
    <section className={`${layout.bgColor} ${layout.ctnerSpacing}`}>
      <div className="container mx-auto md:px-0 px-4">
        ...
        <div className="flex md:flex-row flex-col gap-6 items-start">
          ...
          <div className={`md:w-[27%] grid md:grid-cols-1 ${layout.tabsLayout} md:gap-0 gap-2`}>
          ...
          {/* Content Area */}
          <div
            className={`md:w-[73%] md:p-8 grid ${layout.gridCols} gap-4 md:shadow-[0px_0px_0px_1px] shadow-[#DDEAF9] md:rounded-[20px]`}
          >
            {hasServices ? (
