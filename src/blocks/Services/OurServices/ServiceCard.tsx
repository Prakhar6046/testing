...
export default function ServiceCard({ data, isLast }: Props) {
  ...
  const CardContent = () => (
    ...
    >
      ...
      <h3 className="md:text-[33px] md:leading-[33px] text-[25px] md:leading-[28px] leading-[25px] font-normal mb-2 transition-colors duration-200 group-hover:text-wils_orang">
        {data.title}
      </h3>
      {data.description && (
