      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards?.map((item) => (
            <div
              key={item.id}
              className="bg-[#F7F7F8] rounded-[20px] px-5 py-10 shadow-sm flex flex-col gap-4 h-[376px] transition-all duration-300 ease-in-out hover:transform hover:-translate-y-2 hover:shadow-lg cursor-pointer"
            >
