...
const ResourceFilter: FC<ResourceFilterProps> = ({
  ...
  const displayedTopics = showAllTopics ? availableTopics : availableTopics.slice(0, 5)
  ...
  return (
    <div className="w-full bg-white border border-[#CFDCEC] rounded-[20px] p-4 space-y-10 sticky top-24 self-start">
      <div>
        ...
        {availableTopics.length > 3 && (
          ...
          >
            ...
            <span
              className={`transition-transform duration-300 ${showAllTopics ? 'rotate-90' : 'rotate-0'}`}
            >
              <FaArrowRight />
            </span>
          </button>
      ...
      <div>
        ...
        {availableTypes.length > 3 && (
          ...
          >
            ...
            <span
              className={`transition-transform duration-300 ${showAllTypes ? 'rotate-90' : 'rotate-0'}`}
            >
              <FaArrowRight />
            </span>
          </button>
