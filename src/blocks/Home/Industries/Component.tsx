        ...
        <AnimateOnScroll type="fade-up" delay={getDelay()}>
          ...
          >
            ...
            <div className={cn(layout.imagePosition === 'right' ? 'md:col-start-2' : '')}>
              <div className="relative w-full" style={{ aspectRatio: '579/590' }}>
                <Image
                  src={mainImageUrl}
              ...
              {industries.map((industry, index) => (
                ...
                >
                  ...
                  <div className={`py-5 border-b border-white/20 w-11/12`}>
                    ...
                    <div
                      className={`overflow-hidden transition-all ${animationDurations[behavior.animationSpeed]}`}
                      style={{
                    ...
                    >
                      <p
                        className={`${textColorStyles[layout.textColor]} md:text-xl text-lg font-normal`}
                      >
