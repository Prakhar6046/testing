...
export default function OurServices(props: Props) {
  ...
  const cardFlexBasis = {
    '2': 'sm:flex-[0_0_calc(50%-12px)] lg:flex-[0_0_calc(50%-12px)]',
    '3': 'sm:flex-[0_0_calc(50%-12px)] lg:flex-[0_0_calc(33.333%-16px)]',
    '4': 'sm:flex-[0_0_calc(50%-12px)] lg:flex-[0_0_calc(25%-18px)]',
  }
      ...
      <div className="container mx-auto md:px-5 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {services.map((service, index) => (
            <div key={index} className={`flex-[0_0_100%] ${cardFlexBasis[layout.columns]}`}>
              <AnimateOnScroll type="fade-up" delay={getDelay()}>
                <div
                  className={`
