-- Migration for CMMC Services Overview Block - FINAL CORRECT VERSION
-- Block slug: cmmc_svc_ovw (shortened to fit 63 char limit)
-- Array fields use auto-generated names (no dbName overrides)
-- Longest table name: "_case_studies_v_blocks_cmmc_svc_ovw_remediation_services" = 59 chars
